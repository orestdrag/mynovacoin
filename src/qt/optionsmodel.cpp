...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::BCCACOIN).toInt();
    ...
    fAutoRedeemBCCA = settings.value("fAutoRedeemBCCA", false).toBool();
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemBCCA: return "AutoRedeemBCCA";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::BCCACOIN).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemBCCA: {
            fAutoRedeemBCCA = value.toBool();
            settings.setValue("fAutoRedeemBCCA", fAutoRedeemBCCA);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemBCCA() { return fAutoRedeemBCCA; }
