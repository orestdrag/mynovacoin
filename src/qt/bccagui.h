...
/**
  BCCA GUI main class. This class represents the main window of the BCCA UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BCCAGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit BCCAGUI(QWidget *parent = 0);
    ~BCCAGUI();
