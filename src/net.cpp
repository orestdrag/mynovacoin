...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BCCA " + FormatFullVersion();
...
static const char *strMainNetOnionSeed[][1] = {
	{"ic6ynh2r7c5kfc7v.onion"},
	{"6iajhynq34cks5go.onion"},
	{"jtn4re5cvoox72p6.onion"},
	{"bdpfjtgwcijxidb4.onion"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BCCA is probably already running."), addrBind.ToString());
        else
