...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.bcca
    BOOST_LIB_SUFFIX=-mt
...
contains(BCCA_NEED_QT_PLUGINS, 1) {
    DEFINES += BCCA_NEED_QT_PLUGINS
...
# also add new translations to bcca.qrc under translations/
...
macx:ICON = src/qt/res/icons/bcca.icns
macx:TARGET = "Spectre"
